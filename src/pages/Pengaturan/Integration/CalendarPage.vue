<template>
  <q-page class="tw-flex tw-flex-col tw-pl-0 lg:tw-pl-4 tw-pt-0 lg:tw-pt-3">
    ...
    >
      ...
      />
      <q-breadcrumbs-el class="text-default-3" label="Calendar Sync" />
    </q-breadcrumbs>
    ...
    >
      <div
        ...
        :class="
          $q.dark.isActive ? 'tw-bg-default-1' : 'tw-bg-slate- tw-shadow-md'
        "
      >
        <span
        ...
        <q-list>
          ...
          <q-item
            ...
            class="tw-py-2 tw-my-1 !tw-text-main-gold tw-rounded-md"
            dense
            clickable
            v-ripple
          >
