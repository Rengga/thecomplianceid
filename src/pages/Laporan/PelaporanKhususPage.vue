        ...
        <div class="tw-flex-1 tw-grid tw-grid-cols-1 tw-gap-2 lg:tw-gap-5">
          <div class="tw-flex tw-flex-col tw-space-y-1">
            ...
            >
              ...
              >
                <span class="tw-truncate"> Upcoming Pelaporan </span>
              </div>
              ...
              >
                        ...
                        >
                          ...
                          >
                            <span
                              class="tw-truncate"
                              :class="
                                $q.dark.isActive ? '' : 'tw-text-default-6'
                              "
                            >
                              {{ row.title }}
                            </span>
                ...
                <template v-slot:loading>
                  <div class="row items-center justify-center q-my-md">
                    ...
                    <span
                      :class="
                        $q.dark.isActive ? 'text-white' : 'tw-text-zinc-600'
                      "
                      >Loading...</span
                    >
                  </div>
          ...
          <div class="tw-flex tw-flex-col tw-space-y-1">
            <div
              ...
              :class="
                $q.dark.isActive
                  ? 'tw-bg-default-1 tw-text-white '
                  : 'tw-shadow-md tw-bg-white tw-text-default-6 '
              "
            >
              <div
                class="tw-col-span-1 md:tw-col-span-4 tw-grid tw-grid-cols-1 tw-truncate tw-px-4 tw-py-3"
              >
                <span class="tw-truncate"> Laporan Dalam Proses </span>
              </div>
              <span class="tw-py-3">Deadline</span>
              <span class="tw-py-3">Status</span>
            </div>
...
const qScrollAreaContainer2 = ref(null);
const rows = ref([]);
const rows2 = ref([]);
...
function addItemWithStatus() {
  let maxSize = 50;
  let count = rows2.value.length + 1;
  const namaLaporan = [
    "Penunjukan AP/KAP",
    "Pelaksanaan Hasil Evaluasi Komite Audit",
    "Laporan APU-PPT (Rencana Pengkinian Data Nasabah)",
  ...
  if (count < maxSize) {
    for (let i = 0; i < 10; i++) {
      ...
      rows2.value = rows2.value.concat({
        title: namaLaporan[i],
        tanggal: "12 Januari 2024",
        mTanggal: "12 Jan 2024",
    ...
    rows2.value.forEach((row, idx) => {
      row.index = idx;
    });
  }
}

function onLoadRef2(index, done) {
  setTimeout(() => {
    addItemWithStatus();
    done();
  }, 2000);
